...
export const HomeLatestPosts = (locale: Locale = 'pt') => {
	if (locale == 'pt') {
		...
		return [
			{
				url: '/uy/blog/se-expande-la-cerveceria-de-minas-que-fabrica-la-cerveza-del-bananero/',
				media: 'https://api.braaay.com/uy/wp-content/uploads/sites/2/2024/12/el-bananero.png',
				title: 'Se expande la cervecería de Minas que fabrica la cerveza del Bananero',
				date: '2025-09-02T14:37:33+00:00',
				author: {
					name: 'BRAAAY',
					image:
						'https://api.braaay.com/wp-content/uploads/2024/10/cropped-braaay-map-logo-96x96.jpg'
				},
				readingTime: 'Lectura em 3 min',
