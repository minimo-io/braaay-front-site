<script lang="ts">
	...
	let { title, subTitle, description, buttonText, icon }: Props = $props();
</script>

<!-- Header section -->
<div
	class="max-w-screen-lg flex flex-col lg:flex-row justify-between items-center py-5 md:py-10 px-0 mx-[30px] lg:mx-auto mt-2"
>
	<!-- Left section -->
	<div class="lg:w-[65%]">
		<h4
