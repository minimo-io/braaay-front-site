		...
		>
			...
			<div class="hidden md:block w-[40%] relative">
				<div
					...
					style="background-image: url('/images/teaser-rose.jpg');"
				></div>
			</div>
			...
			<div class="w-full md:w-[70%] p-8 md:p-12 flex flex-col justify-center relative">
				...
				<div class="mb-6">
					<h2
						id="modal-title"
						class="text-4xl md:text-5xl text-blue text-center md:text-left font-medium font-roboto md:leading-none mb-4"
					>
						{@html m.teaserTitle()}
					</h2>
					<p class="text-gray-600 text-lg text-center md:text-left">{m.teaserContent()}</p>
				</div>
					...
					<form method="POST" action="?/subscribe" use:enhance={enhanceSubscribe}>
						<div>
							<input
								...
								class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-[#FAD83E] focus:outline-none text-gray-900 placeholder-gray-500 transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed"
								required
							/>
						</div>
						...
						<button
							type="submit"
							disabled={isSubmitting}
							class="w-full bg-[#FAD83E] hover:bg-blue text-black mt-2 hover:text-white font-bold py-4 px-6 rounded-xl transition-colors text-lg disabled:opacity-50 disabled:cursor-not-allowed"
						>
							{#if isSubmitting}
								Enviando...
							{:else}
					...
					<form action="">
						<div>
							<input
								type="email"
								placeholder="Email (requerido)"
								class="w-full px-4 py-4 border-2 border-gray-200 rounded-xl focus:border-[#FAD83E] focus:outline-none text-gray-900 placeholder-gray-500 transition-colors"
								required
							/>
						</div>

						<button
							class="w-full bg-[#FAD83E] hover:bg-blue text-black hover:text-white font-bold py-4 px-6 rounded-xl transition-colors text-lg"
							onclick={closeTeaserModal}
						>
							{m.teaserButton()}
						</button>
